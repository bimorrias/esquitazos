    ...
    setState(() {
      ...
      if (saboresString != null) {
        ...
        menuSabores = [
          ...
          SaborInfo(id: '3', nombre: 'Tuétano', emoji: '🦴', color: const Color(0xFF854D0E), precioMediano: 60.0, precioGrande: 80.0, costoLoteCompleto: 450.0, costoInsumosMediano: 7.5, costoInsumosGrande: 11.0),
        ];
...
class _CajaRapidaVistaState extends State<CajaRapidaVista> {
  ...
  void _ajustarTotalFluido(double cambio) {
                        ...
                        ...menuSabores.map((sabor) {
                          ...
                          return Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text('${sabor.emoji} ${sabor.nombre}', style: const TextStyle(color: Colors.white70, fontSize: 11)),
                                Text('Med: $med | Gde: $gde', style: const TextStyle(color: Colors.cyan, fontSize: 11, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          );
                        }),
